...
resource "azurerm_storage_account" "sg1" { 
 name      =  "csestologohongretimothee" # add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
...
resource "azurerm_storage_account" "sg2" { 
 name      =  "csestologshongretimothee" # add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
 resource_group_name   =  var.rg_name
 location     =  var.location
 # Performance tier: Standard (HDD-backed)
 account_tier    =  "Standard" 
...
name    =  "sqlserverhongretimothee" # add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.

location    =  var.location 
resource_group_name  =  var.rg_name  
administrator_login   =  "hongreadmin" 
administrator_password =  "hongreadminpassword"
